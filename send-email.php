...
$language = 'es';
$hostName = $_SERVER['HTTP_HOST'] ?? 'brokerlenders.com';
$logoUrl = "https://{$hostName}/logo.png";
$brandName = 'Broker Lenders';
$brandEmail = 'info@brokerlenders.com';
if (is_array($data)) {
...
$clientTexts = [
    'en' => [
        ...
        'thankYou' => "Thank you for contacting {$brandName}. We are committed to providing useful resources and support for homeowners.",
    ...
    'es' => [
        ...
        'thankYou' => "Gracias por contactar a {$brandName}. Estamos comprometidos a brindar recursos y apoyo útiles para propietarios de vivienda.",
